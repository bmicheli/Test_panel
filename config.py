...
/* =============================================================================
 * STYLES CSS SUPPLÉMENTAIRES À AJOUTER DANS config.py (CUSTOM_CSS)
 * =============================================================================*/

/* HPO Suggestion Card Animation */
.hpo-suggestion-card {
    transition: all 0.3s ease;
...
/* Manual Genes Textarea - Smaller Version */
#manual-genes {
    resize: vertical;
